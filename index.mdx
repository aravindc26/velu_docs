...
<CardGroup>
  ...
  <Card title="Configure your site" icon="sliders-horizontal" cta={{ label: "Configure", href: "/configuration/settings" }}>
    Set your name, colors, logo, and navigation in `velu.json`.
  </Card>
  <Card title="Write with components" icon="component" cta={{ label: "Browse components", href: "/components/overview" }}>
...
[AI & optimization](/ai/markdown-export).
