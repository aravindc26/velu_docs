...
See [Themes](/configuration/themes) for the full theming reference, including
dark mode behavior.
...
| `navigation` | object | The sidebar and tab structure. See [Navigation](/configuration/navigation). |
| `seo` | object | Meta tags and indexing. See [SEO](/configuration/seo). |
| `contextual` | object | The per-page "Copy page" menu. See [Contextual menu](/ai/contextual-menu). |
| `assistant` | object | The Ask AI assistant. See [Ask AI](/ai/ask-ai). |
