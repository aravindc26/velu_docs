...
<AccordionGroup>
  ...
  <Accordion title="Navigation">
    ...
    - `#topbar-cta-button`: Call-to-action button in the topbar — the first `kind: "primary"` action.
  ...
  <Accordion title="Page context menu">
    - `#page-context-menu`: Contextual options menu for the current page (Copy page, Markdown, Ask AI).
...
below work verbatim. The one difference: where a component's root must stay a
