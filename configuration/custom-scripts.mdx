...
<Tree>
  <Folder name="my-docs" icon="folder" defaultOpen={true}>
    ...
    <File name="style.css" icon="palette" />
    <Folder name="scripts" icon="folder" defaultOpen={true}>
      <File name="analytics.js" icon="file-code" />
    </Folder>
    <File name="quickstart.mdx" icon="file-text" />
  </Folder>
</Tree>
...
- [Personalized content](/docs/writing/personalization): `window.velu.user` and the `velu:user` event.
