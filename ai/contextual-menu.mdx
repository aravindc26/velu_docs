...
| `view` | Open the page's raw Markdown ([the `.md` twin](/docs/ai/markdown-export)). |
| `assistant` | Open the page's question in [Ask AI](/docs/ai/ask-ai). |
...
| `cursor` | Open the Cursor installer for the [docs MCP server](/docs/ai/model-context-protocol). |
