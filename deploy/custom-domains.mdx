...
<Image src="/docs/images/dashboard/domain-setup.png" alt="The Domain setup page with a field to enter a custom domain and a Host at /docs toggle" />
...
Private authentication works on custom domains and `/docs` subpath hosts. See
[Authentication setup](/docs/deploy/authentication-setup).

See [Publishing](/docs/deploy/publishing) for how sites go live in the first place.
