...
- **Embedded assistant** — Point `useChat` at [Create assistant message](/api-reference/assistant/createassistantmessage). `{domain}` is the hosted hostname (`veludocs.com`, not `veludocs.com/docs`). No API key.
